...
namespace DevBoost.DataTool
{
    ...
    public class DataContainerEditor : Editor
    {
        ...
        void DrawGUI(DataContainerBase container)
        {
            ...
            DevBoost.Utilities.CsvUtilArrayHelper.AddCustumTypeDescriptorProvider();
            ...
            if (GUILayout.Button("Import"))
            {
                if (pagesToggles.Any(t => t.Value == true))
                {
                    ...
                    importQueue = new SheetLoader(container, listsInfos.Where(i => pagesToggles[i.Name] == true).ToArray());
